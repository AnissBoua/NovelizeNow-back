 ...
 */
final class Version20230429142211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE novel ADD price INT NOT NULL AFTER slug, CHANGE status status ENUM(\'published\', \'unpublished\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE novel DROP price, CHANGE status status VARCHAR(255) DEFAULT NULL');
